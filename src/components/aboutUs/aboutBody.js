    ...
    return (
        <div>
            ...
            <section className="allContent">
                <div className="title-and-description">
                    ...
                    <p className="mentorship-description">
                        ...
                        scholarships and internships. ToxSA membership includes
                        affiliation with the NorCal SOT, opening doors to
                        professional networks and additional academic benefits.
                    </p>
                </div>
            ...
            <section className="projects-content">
                ...
                />
                <div className="projects-title-and-description">
