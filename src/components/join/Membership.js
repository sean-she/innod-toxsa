  ...
  <>
    ...
    <section className="benefits-section">
      <div className="benefits-text">
        ...
        <ul>
          <li>Mentorship and networking opportunities and events</li>
          <li>Membership with Society of Toxicology and the Northern California Chapter of the Society of Toxicology</li>
          <li>Workshops and Journal Club experience</li>
          <li>Access to research opportunity and scholarship database</li>
          <li>Socials with a community and support network of students with similar passions and interests</li>
